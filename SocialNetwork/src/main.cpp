...
int main()
{
    ...
    network.registerUser("sahar", "1");
    network.registerUser("ali", "2");
    network.registerUser("reza", "3");
    network.registerUser("maryam", "4");
    cout << "Users registered successfully!\n\n";
    network.registerUser("ahmad", "5");
    network.registerUser("fatemeh", "6");
    network.registerUser("hossein", "7");
    network.registerUser("zahra", "8");
    network.registerUser("mohammad", "9");
    network.registerUser("narges", "10");
    cout << "10 users registered successfully!\n\n";

    User *sahar = network.login("sahar", "1");
    User *ali = network.login("ali", "2");
    User *reza = network.login("reza", "3");
    User *maryam = network.login("maryam", "4");
    User *ahmad = network.login("ahmad", "5");
    User *fatemeh = network.login("fatemeh", "6");
    User *hossein = network.login("hossein", "7");
    User *zahra = network.login("zahra", "8");
    User *mohammad = network.login("mohammad", "9");
    User *narges = network.login("narges", "10");
